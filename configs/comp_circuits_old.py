...
def get_comp_gnn_old_config(args):
    ...
    config.net_params = [config.net_params_1, config.net_params_2]
    config.optimizer_params = [config.optimizer_params_1, config.optimizer_params_2]
