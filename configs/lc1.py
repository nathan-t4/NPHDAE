...
def get_lc1_config(args):
    ...
    config.trial_name =  f'{strftime("%m%d-%H%M")}_{config.n_train}_constant'
    ...
    config.optimizer_params.learning_rate = 0.007
