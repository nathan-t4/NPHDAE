...
class PHDAE():
    ...
    def construct_f_and_g(self):
        def f(x, y, u, t, params):
            E, J, z_vec, diss, B = self.construct_matrix_equations(x, y, t, params) 

            rhs = jnp.linalg.matmul(J, z_vec) - diss + jnp.linalg.matmul(B, u)
    ...
    def solve(self, z0, u, T, params, tol=1e-6):
        return self.solver.solve_dae(z0, u, T, params, tol)
