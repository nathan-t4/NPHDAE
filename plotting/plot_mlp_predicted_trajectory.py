...
# predicted_traj, timesteps = predict_trajectory(model, params, initial_state, 100, 8e-5, control=control_inputs) # for implicit euler
...
T_predicted = T_true
# T_predicted = jnp.linspace(0, 100 * 8e-5, 100)
...
# Plot g values
gnorm, _ = compute_g_vals_along_traj(model.dae.g, params, predicted_traj, T_predicted, num_diff_vars=2)
